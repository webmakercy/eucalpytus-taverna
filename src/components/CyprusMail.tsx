...
export const CyprusMail = () => (
  <section className="py-16 sm:py-24 bg-cream-deep/60">
    <div className="container-tight">
      <div className="bg-card rounded-3xl shadow-card-warm p-8 sm:p-14 max-w-4xl mx-auto relative">
        <Quote className="absolute -top-6 left-8 h-14 w-14 text-secondary opacity-90" strokeWidth={1.5} />
        <p className="text-secondary uppercase tracking-[0.25em] text-xs font-medium mb-4 mt-2">
          Cyprus Mail · Restaurant Review
        </p>
        <h3
          className="font-serif font-semibold mb-6 text-balance"
